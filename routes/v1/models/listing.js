...
function generateAddress(houseNumber, street, area, city, county, eircode) {
    return {
...
function generateDetails(dwelling, description, stayCaveats, leaseLengthMonths, minAge, maxAge, targetSex, targetProfession) {
    return {
        dwelling: dwelling,
...
function generateFacilities(hasWashingMachine, hasDryer, hasParking, hasWifi, hasCentralHeating, hasGarden) {
    return {
...
function generateListing(plan, isOwnerOccupied, isFurnished, ber) {
...
function generate(type, landlordUuid, address, details, bathrooms, bedrooms, facilities, listing) {
    return {
        type: type,
